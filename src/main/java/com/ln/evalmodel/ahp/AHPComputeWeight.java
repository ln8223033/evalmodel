...
public class AHPComputeWeight {
    ...
    public AHPComputeWeight(double[][] matrix) {
    }

    public Map<String, Object> AHPComputeWeight(double[][] matrix) {
        int N = matrix[0].length;
        double[] weight = new double[N];
        AHPComputeWeight instance = AHPComputeWeight.getInstance();
        instance.weight(matrix, weight, N);
        System.out.println(Arrays.toString(weight));
        return instance.weight(matrix, weight, N);
    }
         ...
         * @return
         */
        public Map<String, Object> weight(double[][] a, double[] weight, int N) {
            // 初始向量Wk
